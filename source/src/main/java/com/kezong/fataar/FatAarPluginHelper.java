...
public class FatAarPluginHelper {
    ...
    public static void registerAsmTransformation(Project project, MapProperty<String, List<AndroidArchiveLibrary>> variantPackagesProperty) {
        AndroidComponentsExtension<?, ?, Variant> components = project.getExtensions().getByType(AndroidComponentsExtension.class);
